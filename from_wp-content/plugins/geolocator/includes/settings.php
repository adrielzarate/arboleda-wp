...
function geolocator_setting_select_provider() {
	...
	// Depreciate the providers that does not work any more
	$depreciated_providers = array(
		'telize',
	);

	if( in_array( $options['provider'], $depreciated_providers ) ) {
		$options['provider'] = 'ipapi';
	}
	?>
